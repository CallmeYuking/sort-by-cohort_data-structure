...
def sort_by_cohort(filename):
    ...
    for line in cohort_file:
        line = line.rstrip()
        line = line.split("|")
        if line[2] == '' and line[4] == 'G':
            ghosts.append(line[0] + " " + line[1])

        elif line[4] != 'I' :

            students_only.append(line)

    #     if line[4] != "I" or line[4] != "G":
    #         all_students.extend([line[0],line[1]])
    # print(all_students)

    # print(ghosts)
    # print(students_only)

    winter_16 = [student[0]+ " " + student[1] for student in students_only if student[4] == 'Winter 2016']
    spring_16 = [student[0]+ " " + student[1] for student in students_only if student[4] == 'Spring 2016']
    summer_16 = [student[0]+ " " + student[1] for student in students_only if student[4] == 'Summer 2016']
    fall_15 = [student[0]+ " " + student[1] for student in students_only if student[4] == 'Fall 2015']
